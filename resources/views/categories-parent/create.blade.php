<div class="row">
    <div class="col-md-12">
        <form id="formCategoriesParent" enctype="multipart/form-data" novalidate="novalidate" autocomplete="off">
        @csrf
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        <label for="categories_parents_name">Tên danh mục</label>
                        <input type="text" id="categories_parents_name" name="categories_parents_name" class="form-control" placeholder="Tên danh mục">
                    </div>
        ...
        <div class="model-footer" style="float: right">
            ...
            <button type="button" onclick="pushCategoriesParent()" class="btn btn-info">Submit</button>
        </div>
    </div>
</div>
