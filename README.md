...
```
cd existing_repo
git remote add origin https://gitlab.com/nghia-be/hi-admin-web.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/nghia-be/hi-admin-web/-/settings/integrations)
