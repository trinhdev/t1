...
var FullCalendar = (function (exports) {
    ...
    */
    ...
    var CalendarApi = /** @class */ (function () {
        ...
        // Preference is given to table that have corresponding buttons.
    ...
    */
    ...
    function buildTitle(dateProfile, viewOptions, dateEnv) {
        var range;
        // for table that span a large unit of time, show the proper interval, ignoring stray days before and after
    ...
    */
    ...
    /* An abstract class for the daygrid table, as well as month view. Renders one or more rows of day cells.
    ----------------------------------------------------------------------------------------------------------------------*/
    ...
    */
    ...
    var TableDateProfileGenerator = /** @class */ (function (_super) {
        ...
        TableDateProfileGenerator.prototype.buildRenderRange = function (currentRange, currentRangeUnit, isRangeAllDay) {
            ...
            var endOfWeek;
            // year and month table should be aligned with weeks. this is already done for week
    ...
    var TimeColsView = /** @class */ (function (_super) {
        ...
        function TimeColsView() {
            ...
            _this.renderHeadAxis = function (rowKey, frameHeight) {
                ...
                var navLinkAttrs = (options.navLinks && dayCnt === 1) // only do in day table (to avoid doing in week table that dont need it)
