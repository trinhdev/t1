    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->editColumn('name', function ($row) {
                return '
                    <a href="#" data-id="'.$row->id.'" onclick="detailVoucher(this)">'.$row->name.'</a>
                    <div class="row-options">
                        <a href="#" data-id="'.$row->id.'" onclick="detailVoucher(this)">View</a> |
                        <a href="#" data-id="'.$row->id.'" onclick="dialogConfirmWithAjax(deleteVoucher, this)" class="text-danger">Remove</a>
                    </div>
                ';
            })
            ...
            ->rawColumns(['name','action','checkbox','status']);
    }
